...
const { getFormattedFiltersArray, convertToQueryString } = require('./Utils')
...
class ApiClient { 
   ...
   * @param {String} host The CrossingMids host (null value uses default)
   */
  constructor(refreshToken, host = null) {
    this.#request = host ? new XMindRequest(host) : new XMindRequest();

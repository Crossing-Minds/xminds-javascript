import { ServerError, parseError } from './XMindsError.js'
...
class XMindRequest {
  ...
  getHeaders() {
    return {
      'User-Agent': 'CrossingMinds/' + API_VERSION +
        ' xminds-sdk-js/' + SDK_VERSION + this.userAgent,
  ...
  post(endpoint = "", body = {}, timeout = DEFAULT_TIMEOUT, fetchOptions = {}) {
    let options = {
      ...fetchOptions,
      method: 'POST',
...
const _XMindRequest = XMindRequest;
export { _XMindRequest as XMindRequest };